...
<i>Добро пожаловать в бот</i> 🤍

тебе подойдут программы обучения у Ксю, если ты:

• любишь системность и регулярность в изучении языков
• любишь легкий и непринужденный онлайн формат

если тебе больше всего мешает в достижении результатов:
• нехватка практики
• нерегулярность и лень 
• страх ошибки и плохой опыт

если ты учишь язык для:
• для путешествий
• свободного общения с иностранцами
• того, чтобы разбираться в языке

а сейчас выбери, что ты хочешь сделать:"""
...
PROGRAMS_REPLY_TEXT = """друзья, перед тем как выбирать формат и записываться на занятия, обязательно ознакомьтесь с моими программами обучения 🤲🏻

я собрала их в одном месте, чтобы вам было удобно понять, подходит ли вам направление, как мы будем работать, какие результаты вас ждут и как записаться на диагностику или занятия.

обращайте внимание на блоки с описанием опыта, задач, наполнения и тем — там много важного!  
в программах есть и подпункты, и примеры, и рекомендации по срокам 🧡

если вдруг сайт не открывается, попробуйте отключить wi-fi, перейти на LTE или поэкспериментировать с VPN — обычно это сразу решает проблему.

приятного изучения программ и выбора подходящего направления! ✨
✨"""
...
PAYMENT_REMINDER_DAY_BEFORE = (
    ...
    "Согласно регламентам работы, оплата нового пакета занятий происходит в день "
    "последнего урока после его проведения. Всё в силе?"
)
