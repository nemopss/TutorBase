...
Здесь можно открыть кабинет, посмотреть расписание и получать уведомления по занятиям."""
...
LEGACY_PUBLIC_FLOW_DISABLED = (
    "Этот раздел больше не используется в TutorBase. "
    "Откройте кабинет, чтобы продолжить работу."
)

REGLAMENT_REPLY_TEXT = LEGACY_PUBLIC_FLOW_DISABLED

PROGRAMS_REPLY_TEXT = LEGACY_PUBLIC_FLOW_DISABLED
...
# --- Funnel Handler ---
GET_PRICES_TEXT = LEGACY_PUBLIC_FLOW_DISABLED
...
# --- Admin Handler ---
ADMIN_PANEL = 'Сервисная панель TutorBase:'
...
# --- Cases Handler ---
NO_CASES_YET = "Этот раздел больше не используется в TutorBase."
CASES_LIST_HEADER = "Кейсы:"
...
PAYMENT_REMINDER_WEEK_BEFORE = (
    ...
    "Если продолжаем занятия, новый пакет лучше оплатить до его начала. "
    "Текущий пакет заканчивается {last_lesson_date}. "
...
PAYMENT_REMINDER_DAY_BEFORE = (
    ...
    "Если продолжаем занятия, новый пакет лучше оплатить до его начала. Всё в силе?"
)
