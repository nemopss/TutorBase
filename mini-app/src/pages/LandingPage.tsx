...
const FREE_PLAN = 'Бесплатно до 5 учеников';
...
const faqItems: CollapseProps['items'] = [
  ...
  },
  {
    ...
    children: 'Да. Тариф «Старт» бесплатный для кабинета с 0-5 активными учениками. Можно проверить учеников, расписание, пакеты, напоминания и финансовый учёт без оплаты и банковской карты.',
  },
  {
    key: 'payer',
  ...
  },
  {
    ...
    children: 'Стоимость зависит от количества активных учеников: Старт - бесплатно до 5 учеников, Базовый - 349 ₽, Про - 649 ₽, Бизнес - 1190 ₽ за 30 календарных дней.',
  },
  {
    key: 'active-learners',
  ...
  },
  {
    ...
    children: 'Да. Тариф зависит от количества активных учеников. До 5 активных учеников кабинет работает бесплатно, а на платный тариф можно перейти позже.',
  },
  {
    key: 'learner-stopped',
            ...
            <div className="landing-shell landing-hero-grid">
              <Reveal className="landing-hero-copy">
                ...
                <p className="landing-hero-note">
                  Бесплатно до 5 активных учеников. Без карты и обязательств.
                </p>
              </Reveal>
          ...
          <section className="landing-final-cta">
            <div className="landing-shell">
              <Reveal className="landing-final-card">
                ...
                <small>Бесплатно до 5 активных учеников. Без карты и обязательств.</small>
              </Reveal>
            </div>
          </section>
        </main>
