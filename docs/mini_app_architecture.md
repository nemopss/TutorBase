...
- **Основные API-модули**:
  ...
  - `/reminders`: просмотр и управление напоминаниями с фильтрацией по статусу, типу и пакету, повторная отправка (в перспективе).
...
- **Роутинг и страницы**:
  ...
  - `/reminders` журнал напоминаний с фильтрами по статусу, типу и пакету.
