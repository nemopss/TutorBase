...
class Settings(BaseSettings):
    ...
    NOTIFICATIONS_JOB_LEASE_SECONDS: int = 900
    NOTIFICATIONS_JOB_MAX_ATTEMPTS: int = 5
    NOTIFICATIONS_JOB_RETRY_BASE_SECONDS: int = 30
    NOTIFICATIONS_DELIVERY_LEASE_SECONDS: int = 300
    NOTIFICATIONS_DELIVERY_GRACE_SECONDS: int = 86400
    NOTIFICATIONS_DELIVERY_MAX_ATTEMPTS: int = 5
